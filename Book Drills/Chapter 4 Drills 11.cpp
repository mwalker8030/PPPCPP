/**
 * Before writing out the values from the vector, sort them (that'll make them come out in increasing order). From analyzing the task I'm not sure if it wants me to do this while keeping in mind the units or not. It wouold be more difficult to abide by the units. I will do it without the units for now. I have a good understanding of what would have needed to be done to get the right answer, considering I understand the question.
*/
